...
const DOMAIN_NAME = 'blog.ameilin.com' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '《TypeScript》',link: '/pages/e05dce83e5129785/'},
    ...
    author: {
      name: 'sunbin', // 必需
      link: 'https://github.com/17661977890', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://cdn.jsdelivr.net/gh/17661977890/picgo-file/head.jpeg',
      name: 'Bin Sun',
      slogan: 'Java萌新',
    },
